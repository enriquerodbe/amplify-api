...
import com.amplify.api.domain.coin.{CoinDeadboltHandler, CoinLogic}
import com.amplify.api.domain.venue.auth.{VenueAuthLogic, VenueDeadboltHandler}
...
class AmplifyHandlerCache @Inject()(
  ...
  private val coinHandler = new CoinDeadboltHandler(coinLogic)
