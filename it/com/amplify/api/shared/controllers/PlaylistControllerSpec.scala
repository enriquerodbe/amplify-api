...
import com.amplify.api.shared.exceptions.{InvalidProviderIdentifier, UnexpectedResponse}
import com.amplify.api.shared.services.external.spotify.Converters.toModelPlaylist
...
class PlaylistControllerSpec extends BaseIntegrationSpec with VenueRequests with Inside {
  ...
  val controller = instanceOf[PlaylistController]
